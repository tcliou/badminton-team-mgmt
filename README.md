...
**當前狀態：核心功能（Phase 1~5）已全數完成，持續維護與優化中**
...
| 4 | 稽核日誌、儲存 RLS 強化、球員自助打卡、Admin 重設密碼、安全掃描 CI | ✅ 完成 |
| 5 | 多圖公告、內建頭像庫、球隊設定、教練/文件/行事曆擴充模組 | ✅ 完成 |
...
| **球員** | Admin/Coach | 球員資料管理、頭像上傳（自訂/內建圖庫）、繳費/請假狀態 |
| **家長** | Admin/Parent | 家長帳號與球員綁定關係管理 |
| **教練** | 全員 | 教練資料、資歷與專長介紹 |
| **請假** | Player/Coach | 申請、多選影響訓練、審核、歷史記錄 |
| **訓練** | Coach/Player | 訓練 CRUD、週期性安排、各場次報名與出席總表、球員自助打卡 |
| **繳費** | Player/Finance | 費用項目設定、球員繳費確認（含家長代繳）、証明上傳 |
| **財務** | Finance | 收支總帳、對帳確認、月份切換 |
| **公告** | Coach/Admin | Markdown 與多圖上傳公告（含安全連結過濾）、置頂、排程發布 |
| **文件** | 全員 | 共享文件上傳與下載、權限控管 |
| **行事曆** | 全員 | 球隊專屬行事曆、重點賽事與活動標註 |
| **議題追蹤** | Admin/Coach | 問題回報、Epic/Task 層次、狀態追蹤 |
| **管理後台** | Admin | 使用者 CRUD、角色/權限管理、球隊全域設定、稽核日誌 |
